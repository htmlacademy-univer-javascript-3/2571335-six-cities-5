...
function OfferPage({ offer, guestReview}: {offer:OfferDescription[],guestReview:review[]}):JSX.Element{
  ...
  const filteredOffer:OfferDescription[] = offer.filter(offer => offer.id === id);
    return (
    ...
    <main className="page__main page__main--offer">
      <section className="offer">
        ...
        <div className="offer__container container">
          ...
          {filteredOffer[0].isPremium?<div className="offer__mark">
          <span>Premium</span>
          </div>:null}
                  ...
                  <div className="reviews__info">
                    <div className="reviews__rating rating">
                      <div className="reviews__stars rating__stars">
                        <span style={{width: review.raitingStars}}></span>
                        <span className="visually-hidden">Rating</span>
                      </div>
                    </div>
